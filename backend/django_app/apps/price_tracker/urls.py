...
from .views import PriceTrackingView, PriceHistoryDetailView, PriceSuggestionsView, PricePredictionView
...
urlpatterns = [
    ...
    path('price-prediction/<uuid:product_id>/', PricePredictionView.as_view(), name='price_prediction'),
]
